      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-4 flex-1 max-w-2xl">
            <div className="bg-white px-4 py-2.5 rounded-2xl shadow-sm border border-white/50 flex items-center gap-2 flex-1 focus-within:ring-2 focus-within:ring-[#8C7CF0]/50 transition-all">
            ...
            <div className="bg-white p-2.5 rounded-2xl shadow-sm border border-white/50 cursor-pointer hover:bg-slate-50 transition-colors relative active:scale-95">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-white px-4 py-1.5 rounded-2xl shadow-sm border border-white/50 flex items-center gap-3 cursor-pointer hover:bg-slate-50 transition-colors active:scale-95">
            ...
            <div className="bg-white p-2.5 rounded-2xl shadow-sm border border-white/50 cursor-pointer hover:bg-slate-50 transition-colors active:scale-95">
