      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {selectedTab === 'templates' && (
          <div className="lg:col-span-12 space-y-6">
            {templates.map(tpl => {
              const [localTemplate, setLocalTemplate] = useState(tpl.content_template);
              ...
              return (
                <Card key={tpl.id} className="rounded-[32px] border-none shadow-sm p-6 space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button 
                        ...
                        onClick={() => handleUpdateTemplate(tpl.id, localTemplate)}
                      >
